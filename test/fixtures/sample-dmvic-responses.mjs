...
const sampleDMVICFailedResponses = [
  {
    ...
    callbackObj: {
      ...
      IssuanceMessage:
        'Please note that the details entered do not match NTSA records',
    },
    success: false,
    Error: [
      {
  ...
  {
    Inputs:
      '{"policystartdate":"14/11/2025","policyenddate":"13/11/2026","vehicleregistrationnumber":"KBC705F"}',
    callbackObj: {},
    success: false,
    Error: [
      {
  ...
  {
    Inputs:
      '{"membercompanyid":49,"typeofcover":200,"policyholder":"SA","policynumber":"SAPOL123","commencingdate":"05/12/2025","expiringdate":"112/123/2025","registrationnumber":"KBC705DF","chassisnumber":"ZNE100081633","phonenumber":"708312406","bodytype":"S.WAGON","vehiclemake":"TOYOTA","vehiclemodel":"WISH","email":"iconcept24@gmail.com","suminsured":100000,"insuredpin":"A123456789A"}',
    callbackObj: {},
    success: false,
    Error: [
      {
